...
#        ARCH=i686 ./scripts/portable_package_static.sh
    ...
    osx)
        ...
        xcodebuild "MACOSX_DEPLOYMENT_TARGET=10.13" test -project osx/deadbeef.xcodeproj -scheme deadbeef -configuration Release | xcpretty --test --report junit ; test ${PIPESTATUS[0]} -eq 0
